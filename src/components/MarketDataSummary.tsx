    ...
    <div className="rounded-2xl border border-gray-800 bg-[#111827] p-5 shadow-xl">
      <div className="mb-4 flex items-center justify-between border-b border-gray-800 pb-3">
        <div>
          <div className="flex items-center space-x-2">
            <h2 className="text-xl font-bold text-white">{marketData.ticker}</h2>
            <span className="text-sm text-gray-400 font-medium">{marketData.companyName}</span>
          </div>
          <p className="text-xs text-sky-400 mt-0.5">{marketData.industry}</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-xl border border-gray-800 bg-gray-900/80 p-3">
          ...
          <div className="mt-1 text-base font-bold text-sky-400">{marketData.pe5YearAvg}x</div>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900/80 p-3">
          ...
          <div className="mt-1 text-base font-bold text-purple-400">{marketData.peIndustry}x</div>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900/80 p-3">
          ...
          <div className="mt-1 text-base font-bold text-emerald-400">{marketData.pe5YearMax}x</div>
          <div className="text-[10px] text-gray-500">Kịch bản Tích cực</div>
        </div>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900/80 p-3">
          ...
          <div className="mt-1 text-base font-bold text-rose-400">{marketData.pe5YearMin}x</div>
