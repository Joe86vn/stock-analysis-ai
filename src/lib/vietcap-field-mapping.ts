...
export const VIETCAP_NOTE_MAP: Record<string, VietcapFieldMeta> = {
  ...
  noc2: { code: 'noc2', nameVi: 'Tiền đang chuyển', nameEn: 'Cash in Transit', unit: 'VND' },
  noc3: { code: 'noc3', nameVi: 'Các khoản tương đương tiền', nameEn: 'Cash Equivalents', unit: 'VND' },
  ...
  noc16: { code: 'noc16', nameVi: 'Trả trước cho người bán ngắn hạn chi tiết', nameEn: 'Short-term Prepayments to Suppliers', unit: 'VND' },
  noc17: { code: 'noc17', nameVi: 'Phải thu khác ngắn hạn', nameEn: 'Other Short-term Receivables', unit: 'VND' },
  noc20: { code: 'noc20', nameVi: 'Dự phòng phải thu ngắn hạn khó đòi', nameEn: 'Provision for Doubtful Debts Breakdown', unit: 'VND' },
  noc31: { code: 'noc31', nameVi: 'Hàng mua đang đi trên đường', nameEn: 'Goods in Transit', unit: 'VND' },
  noc32: { code: 'noc32', nameVi: 'Nguyên liệu, vật liệu', nameEn: 'Raw Materials', unit: 'VND' },
  noc33: { code: 'noc33', nameVi: 'Công cụ, dụng cụ', nameEn: 'Tools and Supplies', unit: 'VND' },
  noc34: { code: 'noc34', nameVi: 'Chi phí sản xuất, kinh doanh dở dang', nameEn: 'Work in Progress (WIP)', unit: 'VND' },
  noc35: { code: 'noc35', nameVi: 'Thành phẩm và Hàng hóa tồn kho', nameEn: 'Raw Materials & Finished Goods Inventory', unit: 'VND' },
  noc39: { code: 'noc39', nameVi: 'Dự phòng giảm giá hàng tồn kho chi tiết', nameEn: 'Inventory Provision Breakdown', unit: 'VND' },
  noc41: { code: 'noc41', nameVi: 'TSCĐ hữu hình - Nhà cửa, vật kiến trúc', nameEn: 'Buildings and Structures', unit: 'VND' },
  noc42: { code: 'noc42', nameVi: 'TSCĐ hữu hình - Máy móc, thiết bị', nameEn: 'Machinery and Equipment', unit: 'VND' },
  noc43: { code: 'noc43', nameVi: 'TSCĐ hữu hình - Phương tiện vận tải', nameEn: 'Motor Vehicles and Transport', unit: 'VND' },
  noc51: { code: 'noc51', nameVi: 'Chi phí XDCB dở dang chi tiết theo dự án', nameEn: 'Construction in Progress Project Breakdown', unit: 'VND' },
  noc61: { code: 'noc61', nameVi: 'Đầu tư vào công ty con chi tiết', nameEn: 'Investments in Subsidiaries Breakdown', unit: 'VND' },
  noc62: { code: 'noc62', nameVi: 'Đầu tư vào công ty liên doanh, liên kết chi tiết', nameEn: 'Investments in Associates & JV Breakdown', unit: 'VND' },
  noc71: { code: 'noc71', nameVi: 'Vay ngắn hạn ngân hàng chi tiết', nameEn: 'Short-term Bank Borrowings Breakdown', unit: 'VND' },
  noc72: { code: 'noc72', nameVi: 'Vay dài hạn ngân hàng & Trái phiếu phát hành', nameEn: 'Long-term Bank Borrowings & Bonds Issued', unit: 'VND' },
  noc101: { code: 'noc101', nameVi: 'Doanh thu bán hàng hóa', nameEn: 'Revenue from Sale of Merchandise', unit: 'VND' },
  noc102: { code: 'noc102', nameVi: 'Doanh thu bán thành phẩm', nameEn: 'Revenue from Sale of Finished Goods', unit: 'VND' },
  noc103: { code: 'noc103', nameVi: 'Doanh thu cung cấp dịch vụ', nameEn: 'Revenue from Rendering of Services', unit: 'VND' },
  noc104: { code: 'noc104', nameVi: 'Doanh thu hợp đồng xây dựng', nameEn: 'Revenue from Construction Contracts', unit: 'VND' },
  noc105: { code: 'noc105', nameVi: 'Doanh thu kinh doanh bất động sản', nameEn: 'Revenue from Real Estate Business', unit: 'VND' },
  noc106: { code: 'noc106', nameVi: 'Chiết khấu thương mại và Giảm giá hàng bán', nameEn: 'Trade Discounts & Sales Allowances', unit: 'VND' },
  noc111: { code: 'noc111', nameVi: 'Giá vốn hàng hóa đã bán', nameEn: 'Cost of Merchandise Sold', unit: 'VND' },
  noc112: { code: 'noc112', nameVi: 'Giá vốn thành phẩm đã bán', nameEn: 'Cost of Finished Goods Sold', unit: 'VND' },
  noc113: { code: 'noc113', nameVi: 'Giá vốn dịch vụ đã cung cấp', nameEn: 'Cost of Services Rendered', unit: 'VND' },
  noc114: { code: 'noc114', nameVi: 'Giá vốn kinh doanh bất động sản', nameEn: 'Cost of Real Estate Business', unit: 'VND' },
  noc121: { code: 'noc121', nameVi: 'Lãi tiền gửi, tiền cho vay (Thu nhập lãi)', nameEn: 'Interest Income from Deposits & Loans', unit: 'VND' },
  ...
  noc125: { code: 'noc125', nameVi: 'Doanh thu tài chính khác', nameEn: 'Other Financial Income', unit: 'VND' },
  ...
  noc143: { code: 'noc143', nameVi: 'Thu nhập khác', nameEn: 'Other Sundry Income', unit: 'VND' },
  noc151: { code: 'noc151', nameVi: 'Chi phí phạt vi phạm, thanh lý TSCĐ', nameEn: 'Fines & Disposal of Assets Expense', unit: 'VND' },
  noc152: { code: 'noc152', nameVi: 'Chi phí khác', nameEn: 'Other Sundry Expenses', unit: 'VND' },
  noc161: { code: 'noc161', nameVi: 'Chi phí nguyên liệu, vật liệu trực tiếp', nameEn: 'Direct Raw Materials Cost', unit: 'VND' },
  noc162: { code: 'noc162', nameVi: 'Chi phí nhân công trực tiếp', nameEn: 'Direct Labor Cost', unit: 'VND' },
  noc163: { code: 'noc163', nameVi: 'Chi phí khấu hao TSCĐ sản xuất', nameEn: 'Depreciation of Production Fixed Assets', unit: 'VND' },
  noc164: { code: 'noc164', nameVi: 'Chi phí dịch vụ mua ngoài', nameEn: 'Outside Service Expenses', unit: 'VND' },
  noc165: { code: 'noc165', nameVi: 'Chi phí khác bằng tiền', nameEn: 'Other Cash Operating Expenses', unit: 'VND' },
};
